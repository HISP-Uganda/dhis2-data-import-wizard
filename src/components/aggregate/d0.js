...
import { Delete, ArrowUpward, CloudDownload, Redo } from "@material-ui/icons";
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              className={
                this.integrationStore.dataSet.canPull
                  ? classes.button
                  : classes.hidden
              }
            >
        ...
        <Progress
          open={
            this.integrationStore.isDataSet
              ? this.integrationStore.dataSet.dialogOpen
              : this.integrationStore.dialogOpen
          }
          onClose={
            this.integrationStore.isDataSet
              ? this.integrationStore.dataSet.closeDialog
              : this.integrationStore.closeDialog
          }
          message={
            this.integrationStore.isDataSet
              ? this.integrationStore.dataSet.message
