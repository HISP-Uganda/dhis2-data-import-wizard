    ...
    return (
      <Grid container spacing={8}>
        <Grid item xs={12}>
          ...
          />
          <br />
          {!this.integrationStore.dataSet.organisationUnitInExcel &&
          ...
          {this.integrationStore.dataSet.templateType.value === "3" &&
          this.integrationStore.dataSet.categoryCombo.categories.length ? (
            <Grid container spacing={8}>
              ...
              <Grid container spacing={8}>
                <Grid item xs={6}>
                  <TextField
                    ...
                    onChange={
                      this.integrationStore.dataSet.handleStartPeriodChange
                    }
                  />
                </Grid>
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    onChange={
                      this.integrationStore.dataSet.handleEndPeriodChange
                    }
                  />
                </Grid>
              </Grid>
