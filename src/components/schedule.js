          ...
          <DialogContent>
            ...
            <FormControl component="fieldset">
              ...
              >
                ...
                <FormControlLabel value="attributes" control={<Radio/>} label="Push Attributes"/>
              </RadioGroup>
            </FormControl>
            <Select
            ...
            {this.integrationStore.currentSchedule.type === 'attributes' ? <InputField
              label="Upstream URL"
              type="text"
              fullWidth
              value={this.integrationStore.currentSchedule.upstream}
              onChange={(value) => this.integrationStore.currentSchedule.setUpstream(value)}/> : null}
            <br/>
            <br/>
