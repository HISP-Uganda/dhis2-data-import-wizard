    ...
    return (
      <div className={classes.instructions}>
        ...
        <div style={{ marginBottom: 20 }}>
          {this.getStepContent(this.integrationStore.activeStep)}
        </div>
        <table width="100%">
          <tbody>
            <tr>
              <td width="33%" align="left">
                <Button
                  ...
                  color="secondary"
                  className={
                    this.integrationStore.activeStep === 0 ||
                    this.integrationStore.activeStep >= 7
                      ? classes.hidden
                      : ""
                  }
                >
              ...
              <td width="34%" valign="top" align="center">
                <Button
                  ...
                  color="secondary"
                  className={
                    this.integrationStore.activeStep < 2
                      ? classes.hidden
                      : classes.button
                  }
                >
                ...
                <Button
                  ...
                  color="primary"
                  className={
                    this.integrationStore.activeStep < 3
                      ? classes.hidden
                      : classes.button
                  }
                >
              ...
              <td width="33%" valign="top" align="right">
                <Button
                  ...
                  className={
                    this.integrationStore.activeStep !== 6
                      ? classes.hidden
                      : classes.button
                  }
                >
                ...
                <Button
                  ...
                  className={
                    this.integrationStore.activeStep === 1 ||
                    this.integrationStore.activeStep > 7
                      ? classes.hidden
                      : classes.button
                  }
