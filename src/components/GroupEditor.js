...
export default class GroupEditor extends Component {
    ...
    getItemCount() {
        if (this.getItemStoreIsCollection()) {
            return this.props.itemStore.state.size
        } else if (this.getItemStoreIsArray()) {
            return this.props.itemStore.state.length;
        }
        return 0;
    }
    ...
    render() {
        ...
        const hiddenLabel = itemCount => (this.getItemCount() > 0 && this.getFilterText().length > 0 ? `${itemCount} Hidden` : '');

        const selectedLabel = () => (this.getSelectedCount() > 0 ? `${this.getSelectedCount()} Selected` : '');
        ...
        return (
            <div style={styles.container}>
                <div style={styles.left}>
                    ...
                    >
                        {`Assign All ${this.getAvailableItemsUnfilteredCount() === 0 ? '' : this.getAvailableItemsUnfilteredCount()} \u2192`}
                    </Button>
                </div>
                ...
                <div style={styles.right}>
                    ...
                    >
                        {`\u2190 Remove All ${this.getAssignedItemsUnfilteredCount() > 0 ? this.getAssignedItemsUnfilteredCount() : ''}`}
                    </Button>
                </div>
            </div>
        );
