  ...
  render() {
    ...
    return (
      <div>
        <Stepper
          alternativeLabel
          activeStep={this.integrationStore.activeAggregateStep}
        >
            ...
            return (
              <Step key={label} {...props}>
                <StepButton
                  ...
                  completed={this.integrationStore.isAggregateStepComplete(
                    index
                  )}
                  {...buttonProps}
                >
        ...
        <div className={classes.instructions}>
          <div style={{ marginBottom: 20 }}>
            {this.getStepContent(this.integrationStore.activeAggregateStep)}
          </div>
          <table width="100%">
            <tbody>
              <tr>
                <td width="33%" align="left">
                  <Button
                    ...
                    color="secondary"
                    className={
                      this.integrationStore.activeAggregateStep === 0 ||
                      this.integrationStore.activeAggregateStep >= 6
                        ? classes.hidden
                        : classes.button
                    }
                  >
                ...
                <td width="34%" valign="top" align="center">
                  <Button
                    ...
                    color="secondary"
                    className={
                      this.integrationStore.activeAggregateStep < 2
                        ? classes.hidden
                        : classes.button
                    }
                  >
                  ...
                  <Button
                    ...
                    className={
                      this.integrationStore.activeAggregateStep < 3
                        ? classes.hidden
                        : classes.button
                    }
                  >
                  ...
                  {this.integrationStore.dataSet.sourceOrganisationUnits && this.integrationStore.dataSet.sourceOrganisationUnits
                    .length > 0 && (
                    <Button
                      variant="contained"
                      color="primary"
                      onClick={this.integrationStore.downloadOrgUnitMapping}
                    >
                      Download OrgUnit Mapping
                    </Button>
                  )}
                </td>
                <td width="33%" valign="top" align="right">
                  <Button
                    ...
                    className={
                      this.integrationStore.activeAggregateStep !== 5
                        ? classes.hidden
                        : classes.button
                    }
                  >
                  ...
                  <Button
                    ...
                    className={
                      this.integrationStore.activeAggregateStep === 1 ||
                      this.integrationStore.activeAggregateStep > 7
                        ? classes.hidden
                        : classes.button
                    }
                  >
