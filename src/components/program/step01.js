...
class Step0 extends React.Component {
    ...
    render() {
        return <div>
            ...
            <Progress open={this.integrationStore.isProgram ? this.integrationStore.program.dialogOpen : this.integrationStore.dialogOpen}
                onClose={this.integrationStore.isProgram ? this.integrationStore.program.closeDialog : this.integrationStore.closeDialog}
                message={this.integrationStore.isProgram ? this.integrationStore.program.message : this.integrationStore.message}
            />
        </div>
    }
}
