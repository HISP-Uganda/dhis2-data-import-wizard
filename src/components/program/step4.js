...
class Step4 extends React.Component {
  ...
  componentDidMount() {
    this.integrationStore.setExpanded(
      this.integrationStore.program.programStages[0].id
    );
  }
      ...
      <div>
        {program.programStages.map((n) => {
          return (
            <ExpansionPanel
              key={n.id}
              expanded={this.integrationStore.expanded === n.id}
                    ...
                    <FormControlLabel
                      control={
                        <GreenCheckbox
                          ...
                          onChange={
                            program.isTracker
                              ? n.makeEventDateAsIdentifier({})
                              : n.makeEventDateAsIdentifier(program)
                          }
                        />
                      }
                    ...
                    {n.dataElements.map((s) => {
                            ...
                            >
                              ...
                              <div>
                                <Table className={classes.table}>
                                  ...
                                  <TableBody>
                                    {s.dataElement.optionSet.options.map(
                                      (o) => {
                                        return (
                      ...
                      return (
                        <TableRow key={s.dataElement.id} hover>
                          ...
                          <TableCell>{s.dataElement.displayName}</TableCell>
                          <TableCell>
                            <Select
                          ...
                          <TableCell>
                            <GreenCheckbox
                              checked={s.dataElement.identifiesEvent}
        ...
        <FormHelperText>
          Make sure that all compulsory data elements for a program stage are
          mapped, otherwise next button will be disabled
        </FormHelperText>
        <Progress
