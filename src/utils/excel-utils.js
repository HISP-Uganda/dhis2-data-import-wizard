...
export const processMergedCells = (
  mergedCells,
  data,
  mergedCell,
  processed,
  ...
  const merged = mergedCells.filter((e) => {
    return (
      e.s.r === mergedCell.s.r + 1 &&
      e.s.c >= mergedCell.s.c &&
      e.e.c <= mergedCell.e.c
    );
  });
